...
ScrollReveal().reveal(".header__content .section__description", { ...scrollRevealOption, delay: 100 });
ScrollReveal().reveal(".header__btn", { ...scrollRevealOption, delay: 150 });
...
ScrollReveal().reveal(".explore__content .section__description", { ...scrollRevealOption, delay: 100 });
ScrollReveal().reveal(".explore__btn", { ...scrollRevealOption, delay: 150 });
...
ScrollReveal().reveal(".chef__content .section__description", { ...scrollRevealOption, delay: 100 });
ScrollReveal().reveal(".chef__list li", { ...scrollRevealOption, delay: 150, interval: 500 });
